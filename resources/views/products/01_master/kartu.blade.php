                    ...
                    <div class="row row-cards">
                                                    ...
                                                    <tr class="text-center">
                                                        <td>
                                                            ...
                                                            <form id="deleteForm{{ $item->id }}"
                                                                action="/harga/destroy/{{ $item->id }}" method="POST"
                                                                class="d-inline">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="button"
                        ...
                        <div class="col-6">
                            <div class="card card-xl border-blue-lt shadow rounded">
                                ...
                                <div class="card-body">
                                    <form method="post" action="{{ route('store.harga') }}">
                                        @csrf
                                        <div class="card-stamp card-stamp-lg">
                                            <div class="card-stamp-icon bg-danger">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">Kartu Perdana</label>
                                            <input type="text" class="form-control border border-dark"
                                                name="kartu_perdana" id="kartu_perdana"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('update.harga', $item->id) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                                <label class="form-label">Kartu Perdana</label>
                                <input type="text" class="form-control border border-dark" name="kartu_perdana"
                                    id="kartu_perdana" placeholder="Masukkan Nama Pelanggan"
                                    value="{{ old('kartu_perdana', $item->kartu_perdana) }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Harga</label>
                                <div class="input-group">
