    ...
    <div class="container-fluid">
        ...
        <h1 class="navbar-brand navbar-brand-autodark" style="margin-top: 5px">
            <a href="{{ url('dashboard') }}" style="margin-right: 5px">
                <img src="{{ asset('dycell-1.png') }}" alt="" srcset="">
            </a>
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                    ...
                    <span class="avatar avatar-sm"
                        style="background-image: url(.assetsstatic/avatars/000m.jpg)"></span>
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <a href=".assetsprofile.html" class="dropdown-item">Profile</a>
                    <a href="#" class="dropdown-item">Feedback</a>
                    <div class="dropdown-divider"></div>
                    <a href=".assetssettings.html" class="dropdown-item">Settings</a>
                    <a href=".assetssign-in.html" class="dropdown-item">Logout</a>
                </div>
            </div>
        </div>
