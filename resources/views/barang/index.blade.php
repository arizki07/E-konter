                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select border border-dark" name="id_kategori">
                                            ...
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control border border-dark"
                                                        name="brand" placeholder="Masukkan Nama Brand">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control border border-dark"
                                                        name="type_barang" placeholder="Masukkan Nama Type">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control border border-dark"
                                                        name="model_barang" placeholder="Masukkan Nama Model">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control border border-dark"
                                                        name="harga" placeholder="Masukkan Nama Harga">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control border border-dark"
                                                        name="stock" placeholder="Masukkan Nama Stock">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control border border-dark" name="keterangan" placeholder="Masukkan Keterangan"></textarea>
                                                </div>
                                            </div>
                                        </div>
